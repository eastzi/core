...
//		DiscountPolicy bean = ac.getBean(DiscountPolicy.class);
		assertThrows(NonUniqueSessionRepositoryException.class, () -> ac.getBean(DiscountPolicy.class));
	}
	...
	void findBeanByParentTypeBeanName() {
		...
		assertThat(rateDiscountPolicy).isInstanceOf(rateDiscountPolicy.getClass());
	}
